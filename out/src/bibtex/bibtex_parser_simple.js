...
function peg$parse(input, options) {
  ...
  var peg$e7 = peg$literalExpectation("@string", true);
  var peg$e8 = peg$literalExpectation("=", false);
  var peg$e9 = peg$literalExpectation("@preamble", true);
  ...
  var peg$f2 = function(entryType, internalKey, fields) {
  ...
  var peg$f8 = function(begin, x) { return x; };
  var peg$f9 = function(begin, fields) {
        return [begin].concat(fields);
    };
  var peg$f10 = function(name, value) {
        return { name, value, location: location() };
    };
  var peg$f11 = function(begin, rest) {
